...
namespace MusicStoreMobile.Core.ViewModels.Auth
{
    public class RegistrationViewModel : BaseViewModel
    {
        ...
        public RegistrationViewModel(IMvxNavigationService navigationService, IAuthService authService, 
            IUserDialogs userDialogs, IValidator validator/*, ILocationService locationService*/, 
            MvvmCross.Plugins.Validation.IMvxToastService toastService,
            IBottomNavigationViewModelService bottomNavigationViewModelService, 
            ITopNavigationViewModelService topNavigationViewModelService,
        ...
        private async Task AttemptRegisterAsync()
        {
            ...
            if (_validationHelper.Validate())
            {
                ...
                if (serviceResult.Success)
                {
                    ...
                    _notificationService.ShowNotification<LibraryViewModel>();
